...
function formatLength(minutes?: number | null) {
...
<template>
    <div class="bg-white shadow rounded-xl p-6">
        <h2 class="text-slate-900 mb-6 font-semibold">
            Edition Details
        </h2>
        ...
        <div class="space-y-4">
            ...
            >
                ...
                <div>
                    ...
                    <p class="text-slate-900 break-words">
                        {{ edition.publisher }}
                    </p>
                </div>
            </div>
            ...
            <div
                v-if="formatDate(edition.edition_publication_date)"
                class="flex items-start gap-3"
            >
                <span class="text-slate-500">📅</span>
            ...
            <div
                v-if="formatLength(edition.length_minutes)"
                class="flex items-start gap-3"
            >
